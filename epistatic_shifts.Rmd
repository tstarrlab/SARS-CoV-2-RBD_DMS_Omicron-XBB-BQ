...
Same but faceted
```{r line_plots_JSD_v_BA2_Omi-reduced_min3bc_facet, echo=T, fig.width=12, fig.height=16, fig.align="center", dpi=300,dev="png"}
...
Same but faceted
```{r line_plots_JSD_v_WH1_Omi-reduced_min3bc_facet, echo=T, fig.width=12, fig.height=16, fig.align="center", dpi=300,dev="png"}
...
```{r line_plots_JSD_v_BA2_min3bc_expr, echo=T, fig.width=12, fig.height=4, fig.align="center", dpi=300,dev="png"}
#define focal bg for others to compare to
bg <- "Omicron_BA2"
temp <- diffs_expr[bg_1==bg,]
temp$target <- as.character(temp$bg_2)
